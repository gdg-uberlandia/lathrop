            ...
            <Container id="about">
                <Row>
                    ...
                    <Col lg={4} sm={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <img height="300px" src="/public/sticker.gif" alt='Animações com a logo do DevFest Triangulo, alguns traços e desenhos na cor amarela aparecendo gradativamente na tela'></img>
                    </Col>

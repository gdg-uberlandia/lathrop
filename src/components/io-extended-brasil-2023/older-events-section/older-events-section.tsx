        ...
        <Row>
          <Col lg={8} sm={12}>
            ...
            <p className={styles.Description}>
              ...
              <br />
              <br />
              No dia 10 de maio de 2023 tivemos em São Francisco na Califórnia o
              Google I/O. A conferência é realizada pela Google com o objetivo
              de mostrar as novidades da empresa para o ano corrente e em 2023
              ela foi fechada para convidados.
              <br />
              <br />
              Em 24 de maio, rolou o Google I/O Connect em Miami. O evento foi
              idealizado para organizadores da comunidade Google Developers
              Group, Google Developers Expert e embaixadoras Women Techmakers. O
              Google I/O Extended é o compartilhamento de conhecimentos
              adquiridos nos eventos citados acima para a comunidade local.
              <br />
              <br />
              Neste ano, GDGs de todas as regiões do país, se reuniram para
              trazer muito conteúdo, de forma gratuita, online e acessível para
              todas as pessoas. Vai perder essa oportunidade de ficar por dentro
              de novas tecnologias Google? Nos acompanhe nas redes sociais para
              saber cada detalhe desse evento incrível.
              <br />
          ...
          >
            <img src={"/io-sticker.png"} className={styles.SupportImage} />
          </Col>
        </Row>
      </Container>
